...
\section{Objective}
\descript{Seeking an entry-level position to start my career where my strong analytical and problem-solving skills will be utilized and passionately develop myself while helping the community. }
...
\descript{ - Finalist : Hindustan Unilever Limited HACKATHON | 2017.\\
 ...
 - 4 Stars [ 1833 ] CodeChef Rating  LINK:\href{https://www.codechef.com/users/onkar27}{\custombold{ onkar27 }}
}
\end{minipage}
...
\descript{
Mr. Swapnil Sontakke (Teacher)\\
+918149238847\\
\href{mailto:swapnil.sontakke@walchandsangli.ac.in}{
swapnil.sontakke@walchandsangli.ac.in }
}
\sectionsep
\sectionsep
